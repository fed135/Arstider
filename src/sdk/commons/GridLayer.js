 ...
 */
define( "Arstider/commons/GridLayer", ["Arstider/DisplayObject", "Arstider/Bitmap", "Arstider/Buffer", "Arstider/Preloader"], /** @lends commons/GridLayer */ function (DisplayObject, Bitmap, Buffer, Preloader) {
	...
	GridLayer.prototype._createTile = function(x, y){
		...
		return ret;
               ...
               GridLayer.prototype._prepareChunks = function(){
                   var 
                       chunk = null,
                       tilesPerChunkX = Arstider.ceil(GridLayer.MIN_CHUNK_SIZE/this.tileSizeX),
                       numChunksX = Arstider.ceil(this.parent.mapWidth/tilesPerChunkX),
                       tilesPerChunkY = Arstider.ceil(GridLayer.MIN_CHUNK_SIZE/this.tileSizeY),
                       numChunksY = Arstider.ceil(this.parent.mapHeight/tilesPerChunkY),
                       i=0,
                       u=0
                   ;
